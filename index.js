...
case 'creador': 
case 'developer':
number = '573102785788@s.whatsapp.net'
...
*≡ OWNER*
▢ WhatsApp : wa.me/573102785788 
*≡ SCRIPT*
▢ Git : ${package.homepage} 
` 
Fg.send2Button(from, teks, '*_© RonBot_*', `ꨄ︎ Apoyar`, `${prefix}donate`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
   break
...
▢ *Pregunta:* ${value}
▢ *Respuesta :* ${prefg.success.replace('simsimi', 'RonBot').replace('Simsimi', 'RonBot').replace('sim simi', 'RonBot')}`) 
break 
